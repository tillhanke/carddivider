...
\pgfmathsetmacro{\cardwidth}{63mm} % {\the\paperwidth}
\pgfmathsetmacro{\cardheight}{111mm} % {\the\paperheight}
...
\newcommand{\miniscule}[1]{{\fontsize{4}{5}\selectfont#1}}
...
\newcommand{\card}{
	...
	% Cardextension
	% \node [anchor=south east,black,minimum width=\stripwidth,minimum height=0.7cm] (cardextension) at ([xshift=-1*\stripwidth,yshift=0.5*\contentoffset]content.north east) {\tiny{\trajan \cardextension}};
	...
	% Cardextensiontitle
	% \node [anchor=south east,black,minimum width=\stripwidth,minimum height=0.7cm] (cardextensiontitle) at ([xshift=-1*\stripwidth]content.north east) {\tiny{\trajan \cardextensiontitle}};
